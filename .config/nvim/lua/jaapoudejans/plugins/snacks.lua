return {
    {
        ...
        keys = {
            ...
            { "<leader>ps", function() Snacks.picker.grep() end, desc = "Grep Word"},
            {"<leader>pws", function() Snacks.picker.grep_word() end, desc = "Search Visual selection or Word", mode = {"n", "x"}},
            {"<leader>pk", function() Snacks.picker.keymaps({layout = "ivy"}) end, desc = "Search Keymaps"},

            {"<leader>gbr", function() Snacks.picker.git_branches({layout = "select"}) end, desc = "Switch Git Branches"},
            {"<leader>th", function() Snacks.picker.colorschemes({layout = "ivy"}) end, desc = "Switch Color Schemes"},
